...
from src.infrastructure.providers import get_driver, is_provider_supported
...
def provision_cloud_node(
    ...
    Example:
        >>> from src.infrastructure.providers.libcloud_dynamic_provider import provision_cloud_node
        >>>
