...
class TestLogsNoCluster:
    @patch("src.cli.commands.logs._check_cluster", return_value=False)
...
class TestLogsListJobs:
    @patch(
        "src.cli.commands.logs._list_running_jobs",
        return_value=[
            {
                "id": "researcher",
                "type": "service",
    ...
    @patch("src.cli.commands.logs._check_cluster", return_value=True)
    ...
    @patch("src.cli.commands.logs._list_running_jobs", return_value=[])
    @patch("src.cli.commands.logs._check_cluster", return_value=True)
...
class TestLogsStreaming:
    @patch("src.cli.commands.logs.subprocess.Popen")
    @patch("src.cli.commands.logs._check_cluster", return_value=True)
    ...
    @patch("src.cli.commands.logs.subprocess.Popen", side_effect=FileNotFoundError)
    @patch("src.cli.commands.logs._check_cluster", return_value=True)
