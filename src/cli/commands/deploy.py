...
from src.cli.ui.panels import console, show_success, show_error, show_info, show_step
from src.cli.ui.themes import MESH_CYAN
...
def run_deploy(
    ...
    if demo:
        ...
        try:
            from src.workloads.deploy_app.deploy import deploy_app
