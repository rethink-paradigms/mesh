...
from src.verification.e2e_multi_node_scenarios.test_utils import (
    ClusterConfig,
    get_cluster_nodes,
    get_multipass_ip,
    deploy_job,
...
class TestGetClusterNodes:
    ...
    @patch("src.verification.e2e_multi_node_scenarios.test_utils.get_multipass_ip")
...
class TestCheckTailscaleMesh:
    ...
    @patch("src.verification.e2e_multi_node_scenarios.test_utils.get_cluster_nodes")
