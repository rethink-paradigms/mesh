...
from mesh.infrastructure.provision_node.multipass import provision_multipass_node, generate_cloud_init_yaml
...
@patch("mesh.infrastructure.provision_node.multipass.click.echo") # Mock click.echo to prevent output during tests
