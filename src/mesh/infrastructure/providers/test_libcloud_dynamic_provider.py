...
class TestProviderSupport:
    ...
    @patch('mesh.infrastructure.providers.libcloud_dynamic_provider.pulumi.get_stack', return_value='test-stack')
    def test_create_with_unknown_provider_fails(self, mock_get_stack):
        ...
        """
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.pulumi.get_project', return_value='test-project'):
...
class TestCreateMethod:
    ...
    @patch('mesh.infrastructure.providers.libcloud_dynamic_provider.pulumi.get_stack', return_value='test-stack')
    @patch('mesh.infrastructure.providers.libcloud_dynamic_provider.pulumi.get_project', return_value='test-project')
    def test_create_with_exact_size_id(self, mock_get_project, mock_get_stack):
        ...
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_region_available', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_size', return_value=mock_size), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.find_ubuntu_image', return_value=mock_image), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_driver', return_value=mock_driver):
    ...
    def test_create_with_invalid_size_id_fails(self, mock_get_project, mock_get_stack):
        ...
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_region_available', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_size', return_value=None):
    ...
    def test_create_with_invalid_region_fails(self, mock_get_project, mock_get_stack):
        ...
        """
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_region_available', return_value=False):
    ...
    def test_create_with_explicit_image_id(self, mock_get_project, mock_get_stack):
        ...
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_region_available', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_size', return_value=mock_size), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_image', return_value=mock_image), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_driver', return_value=mock_driver):
    ...
    def test_create_auto_discovers_ubuntu_image(self, mock_get_project, mock_get_stack):
        ...
        with patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_region_available', return_value=True), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_size', return_value=mock_size), \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.find_ubuntu_image', return_value=mock_ubuntu_image) as mock_find, \
             patch('mesh.infrastructure.providers.libcloud_dynamic_provider.get_driver', return_value=mock_driver):
...
class TestDeleteAndReadMethods:
    ...
    @patch('mesh.infrastructure.providers.libcloud_dynamic_provider.is_provider_supported', return_value=True)
