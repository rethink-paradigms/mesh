...
class TestDeploy:
    @patch("src.workloads.deploy_lite_web_service.deploy.os.path.exists")
    def test_deploy_missing_job_file(self, mock_exists):
        mock_exists.return_value = False
        from src.workloads.deploy_lite_web_service.deploy import deploy_lite_web_service
    ...
    @patch("src.workloads.deploy_lite_web_service.deploy.RouteManager")
    @patch("src.workloads.deploy_lite_web_service.deploy.subprocess.run")
    @patch("src.workloads.deploy_lite_web_service.deploy.os.path.exists")
