...
from src.infrastructure.progressive_activation.tier_config import ClusterTier
from src.workloads.deploy_app.deploy import _detect_tier_from_nomad, deploy_app


@patch(
    "src.workloads.deploy_app.deploy._detect_tier_from_nomad",
    return_value=ClusterTier.LITE,
)
@patch(
    "src.workloads.deploy_lite_web_service.deploy.deploy_lite_web_service",
    return_value=True,
)
...
@patch("src.workloads.deploy_app.deploy.subprocess.run")
